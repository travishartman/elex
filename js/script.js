...
//
    function makeMap(){
      ...
      queue()
      // listed as "mo" in the ready funciton
...
function ready(error, theMoMapData, data) {
...
var counties = topojson.feature(theMoMapData, theMoMapData.objects.mo_county_slice);
